...
datafiles<-list.files("/gscratch/emcfarl2/TrianglePlots/",  pattern="*.main", recursive=TRUE, include.dirs=TRUE)
...
alldata_df[which(alldata_df$gen==1 & alldata_df$m==0.01),]->gen_1_0.01
alldata_df[which(alldata_df$gen==1 & alldata_df$m==0.2),]->gen_1_0.2
...
pdf(file="triangles_for_triangles_1_0.01.pdf", width=10, height=10)
  ...
  for (i in 1:500)
  {
    points(gen_1_0.01[i,5], gen_1_0.01[i,6], pch=21, bg=adjustcolor(triangle_cols[1], alpha.f=0.75), cex=2)
  }
  box(lwd=2)
dev.off()  
...
for (i in 1:500)
{
  points(gen_10_0.01[i,5], gen_10_0.01[i,6], pch=21, bg=adjustcolor(triangle_cols[2], alpha.f=0.75), cex=2)
}
box(lwd=2)
dev.off() 

pdf(file="triangles_for_triangles_100_0.01.pdf", width=10, height=10)
plot(0, type="n", xlab="q", ylab="Q", xlim=c(0, 1), ylim=c(0, 1), las=1, cex.lab=1.5, cex.axis=1.25)
segments(0, 0, 0.5, 1, lwd=3)
segments(1, 0, 0.5, 1, lwd=3)
for (i in 1:500)
{
  points(gen_100_0.01[i,5], gen_100_0.01[i,6], pch=21, bg=adjustcolor(triangle_cols[3], alpha.f=0.75), cex=2)
}
box(lwd=2)
dev.off() 


pdf(file="triangles_for_triangles_1_0.2.pdf", width=10, height=10)
plot(0, type="n", xlab="q", ylab="Q", xlim=c(0, 1), ylim=c(0, 1), las=1, cex.lab=1.5, cex.axis=1.25)
segments(0, 0, 0.5, 1, lwd=3)
segments(1, 0, 0.5, 1, lwd=3)
for (i in 1:500)
{
  points(gen_1_0.2[i,5], gen_1_0.2[i,6], pch=21, bg=adjustcolor(triangle_cols[1], alpha.f=0.75), cex=2)
}
box(lwd=2)
dev.off()  

pdf(file="triangles_for_triangles_10_0.2.pdf", width=10, height=10)
plot(0, type="n", xlab="q", ylab="Q", xlim=c(0, 1), ylim=c(0, 1), las=1, cex.lab=1.5, cex.axis=1.25)
segments(0, 0, 0.5, 1, lwd=3)
segments(1, 0, 0.5, 1, lwd=3)
for (i in 1:500)
{
  points(gen_10_0.2[i,5], gen_10_0.2[i,6], pch=21, bg=adjustcolor(triangle_cols[2], alpha.f=0.75), cex=2)
}
box(lwd=2)
dev.off() 

pdf(file="triangles_for_triangles_100_0.2.pdf", width=10, height=10)
plot(0, type="n", xlab="q", ylab="Q", xlim=c(0, 1), ylim=c(0, 1), las=1, cex.lab=1.5, cex.axis=1.25)
segments(0, 0, 0.5, 1, lwd=3)
segments(1, 0, 0.5, 1, lwd=3)
for (i in 1:500)
{
  points(gen_100_0.2[i,5], gen_100_0.2[i,6], pch=21, bg=adjustcolor(triangle_cols[3], alpha.f=0.75), cex=2)
}
box(lwd=2)
dev.off() 
